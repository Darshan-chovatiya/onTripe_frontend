          ...
          <div className="p-4 border-b border-gray-100 flex flex-wrap items-center justify-between gap-3 bg-gray-50/50">
             ...
             <div className="relative">
                ...
                <input 
                  ...
                  className="pl-9 pr-3 py-1.5 border border-gray-200 rounded-lg text-xs w-48 focus:outline-none focus:ring-2 focus:ring-primary-500/10 shadow-sm bg-white"
                  value={search}
