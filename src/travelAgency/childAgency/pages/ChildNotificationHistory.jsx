...
export default function ChildNotificationHistory() {
    ...
    <div className="animate-fade-in space-y-6 pb-10">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">All broadcasts sent to your sub-child agents</p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="rounded-2xl border border-dashed border-gray-200 bg-gray-50/70 px-6 py-20 text-center">
          ...
          <p className="mt-1 text-sm text-gray-500">Notifications you send to sub-child agents will appear here.</p>
          <Link to="/agency/manage-downstream"
