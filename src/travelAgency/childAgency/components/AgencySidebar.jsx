...
import { X, LogOut, LayoutDashboard, CalendarDays, Users, Settings, Package, UserCircle } from 'lucide-react'
import { useAuth } from '@/shared/context/AuthContext.jsx'
import ConfirmDialog from '@/shared/components/ConfirmDialog.jsx'
import logoIcon from '@/assets/onTripLogo.png'

const BASE = '/agency/child'
...
export default function AgencySidebar({ isOpen, onClose }) {
  ...
  const navItems = [
    ...
    { path: `${BASE}/customers`, icon: UserCircle, label: 'Customers' },
    { path: `${BASE}/manage-sub-children`, icon: Users, label: 'Manage sub-children' },
  ...
  return (
    <>
      <aside
        className={`fixed lg:static inset-y-0 left-0 z-50 flex w-64 flex-col border-r border-gray-800/50 bg-slate-900 transition-transform duration-300 lg:translate-x-0 ${
      ...
      >
        <div className="flex h-16 items-center justify-between border-b border-gray-800/50 px-4 sm:px-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-lg font-bold text-white">Child agency</div>
