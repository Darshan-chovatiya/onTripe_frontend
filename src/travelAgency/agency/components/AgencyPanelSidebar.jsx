  ...
  return (
    <>
      ...
      >
          ...
          <div className="flex w-full items-center justify-between gap-2">
            <div className="flex min-w-0 flex-1 items-center gap-2.5 sm:gap-3">
              ...
              <div className="min-w-0 leading-tight">
                ...
                <p className="truncate text-sm font-semibold text-white" title={panelName}>
                  {panelName}
                </p>
              </div>
            </div>
        ...
        <nav className="flex-1 overflow-y-auto px-3 py-4" aria-label="Agency navigation">
          <p className="mb-2 px-3 text-[11px] font-semibold uppercase tracking-[0.16em] text-gray-400">Menu</p>
