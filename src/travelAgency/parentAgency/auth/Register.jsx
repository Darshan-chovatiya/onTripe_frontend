...
import { User, Mail, Lock, Phone, Eye, EyeOff, Ticket, FileUp, ShieldCheck } from 'lucide-react'
...
export default function ParentRegister() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (res.success) {
      ...
      setTimeout(() => navigate('/travelAgency/parent/login'), 2500)
    } else {
    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 p-4">
      <div className="w-full max-w-lg animate-scale-in rounded-xl border border-gray-200 bg-white p-8 shadow-sm">
        <div className="mb-6 text-center">
          ...
          <p className="mt-1 text-sm text-gray-600">Start your primary travel agency partnership</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="mb-1 flex items-center gap-2 text-sm font-medium text-gray-700">
                <Lock className="h-4 w-4 text-primary-500" /> Choose Password <span className="text-red-500">*</span>
              </label>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                <div className="pt-2 text-[11px] leading-relaxed text-gray-500">
                  By clicking Register, you agree to our terms and conditions. Your account will remain pending until KYC verification is completed by our admin team.
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-8 text-center text-sm">
          ...
          <Link to="/travelAgency/parent/login" className="font-semibold text-primary-600 hover:underline">
            Sign In Here
          </Link>
        </div>
      </div>
