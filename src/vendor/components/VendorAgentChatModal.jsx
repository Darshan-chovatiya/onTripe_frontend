...
export default function VendorAgentChatModal({ isOpen, onClose }) {
  ...
  const fetchMessages = async () => {
    try {
      const res = await axiosInstance.get('/vendor/chat-agent')
      if (res.data?.success) {
  ...
  const handleSendMessage = async (e) => {
    ...
    try {
      ...
      const res = await axiosInstance.post('/vendor/chat-agent', formData, {
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-100 bg-gray-50">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">Parent Agent</p>
            </div>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50/50">
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center h-full text-gray-400">
              <p className="text-sm">Chat with your parent agency.</p>
            </div>
          ) : (
