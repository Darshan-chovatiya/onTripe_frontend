  ...
  return (
    <>
          ...
          <div className="flex items-center gap-3">
            <div
              className={`w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg ${
                logoError ? 'bg-gradient-to-br from-primary-500 to-primary-600 shadow-primary-500/30' : 'overflow-hidden'
              }`}
            >
              {logoError ? (
            ...
            <div className="align-middle">
              ...
              <div className="text-gray-400 text-xs font-medium">Panel</div>
            </div>
          </div>
          <button
            type="button"
      ...
      <ConfirmDialog
        ...
        message="Are you sure you want to logout? You will need to login again to access the parents panel."
        confirmText="Logout"
        cancelText="Cancel"
        variant="danger"
      />
